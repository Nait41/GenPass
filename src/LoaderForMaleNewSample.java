...
public class LoaderForMaleNewSample {
    XWPFDocument workbook;
    String nameObr;

    public LoaderForMaleNewSample(){}

    public LoaderForMaleNewSample(String nameObr) throws IOException, InvalidFormatException {
