...
public class LoaderForFemaleOldSample {
    XWPFDocument workbook;
    String nameObr;

    public LoaderForFemaleOldSample(){}

    public LoaderForFemaleOldSample(String nameObr) throws IOException, InvalidFormatException {
