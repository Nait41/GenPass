...
public class LoaderForFemaleNewSample {
    XWPFDocument workbook;
    String nameObr;

    public LoaderForFemaleNewSample(){}

    public LoaderForFemaleNewSample(String nameObr) throws IOException, InvalidFormatException {
